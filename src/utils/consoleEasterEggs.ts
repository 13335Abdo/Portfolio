...
export const printConsoleEasterEggs = () => {
  console.log(`%c${ASCII_ART}`, 'color: #228b22; font-family: monospace; font-size: 14px;');

  console.log(
    `%c${GREETING}`,
    'color: #228b22; font-size: 16px; font-weight: bold; padding: 8px 0;'
  );
  ...
  console.log(
    ...
    'color: #228b22; font-size: 12px; font-style: italic; padding-top: 8px;'
  );
};
