    ...
    >
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 py-8 sm:flex-row">
        <p className="text-sm text-muted-foreground">
          &copy; {year} Abdelrahman Rabi3
          <Button
            aria-label="You found a bug!"
            className="ml-2 h-auto w-auto p-0 text-muted-foreground/20 hover:bg-transparent hover:text-brand-accent hover:drop-shadow-[0_0_4px_rgba(34,139,34,0.45)]"
