        ...
        <div className="flex flex-1 flex-col items-center justify-between gap-4 overflow-hidden md:gap-8 lg:flex-row lg:gap-6">
          <div className="w-full shrink-0 md:max-w-lg lg:w-1/3">
            <img
              ...
              src={`https://streak-stats.demolab.com/?user=noranda&hide_border=true&background=00000000&ring=228b22&fire=2e8b57&currStreakLabel=${theme === 'dark' ? 'c9d1d9' : '1f2328'}&sideLabels=${theme === 'dark' ? 'c9d1d9' : '1f2328'}&currStreakNum=${theme === 'dark' ? 'c9d1d9' : '1f2328'}&sideNums=${theme === 'dark' ? 'c9d1d9' : '1f2328'}&dates=${theme === 'dark' ? '8b949e' : '57606a'}`}
            />
          </div>
          <div className="w-full flex-1">
            <img
              ...
              src="https://ghchart.rshah.org/228b22/noranda"
            />
          </div>
        </div>
      </a>
