...
export const COLOR_GROUPS: ColorGroup[] = [
  ...
  },
  {
    colors: [
      {
        darkValue: 'oklch(0.558 0.169 142.89)',
        lightValue: 'oklch(0.558 0.169 142.89)',
        name: 'brand',
        variable: '--brand',
      },
      {
        darkValue: 'oklch(0.664 0.122 169.38)',
        lightValue: 'oklch(0.664 0.122 169.38)',
        name: 'brand-accent',
  ...
  },
  {
    colors: [
      ...
      {
        darkValue: 'oklch(0.55 0.08 205)',
        lightValue: 'oklch(0.48 0.072 208)',
        name: 'info',
        variable: '--info',
      },
      {
        darkValue: 'oklch(0.72 0.11 169)',
        lightValue: 'oklch(0.664 0.122 169.38)',
        name: 'success',
        variable: '--success',
      },
      {
        darkValue: 'oklch(0.78 0.12 168)',
        lightValue: 'oklch(0.334 0.08 156.98)',
        name: 'success-foreground',
        variable: '--success-foreground',
      },
      {
        darkValue: 'oklch(0.28 0.055 165 / 30%)',
        lightValue: 'oklch(0.95 0.035 155)',
        name: 'success-muted',
  ...
  },
  {
    colors: [
      ...
      {
        darkValue: 'oklch(0.55 0.08 200)',
        lightValue: 'oklch(0.334 0.08 156.98)',
        name: 'chart-3',
        variable: '--chart-3',
      },
      {
        darkValue: 'oklch(0.65 0.11 155)',
        lightValue: 'oklch(0.569 0.119 154.95)',
        name: 'chart-4',
        variable: '--chart-4',
      },
      {
        darkValue: 'oklch(0.58 0.1 127)',
        lightValue: 'oklch(0.496 0.09 126.19)',
        name: 'chart-5',
        variable: '--chart-5',
      },
    ],
