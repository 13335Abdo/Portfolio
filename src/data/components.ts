...
export const COMPONENTS: ComponentShowcase[] = [
  ...
  },
  {
    ...
    name: 'Toast',
    reality:
      "These toasts glow. Like, actually glow. Green for success, red for errors, teal for info, because if you're going to interrupt someone's flow, you might as well make it pretty. They stack, they dismiss, and the close button has a hover state because I have standards.",
