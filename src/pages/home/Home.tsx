...
export const Home = () => (
  <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
    <PageMeta
      description="Portfolio of Abdelrahman Rabi3, Frontend Engineer specializing in design systems, visual testing, and accessible React applications."
      path="/"
      title="Abdelrahman Rabi3 | Frontend Engineer"
    />
    {/* ── Bento Grid ── */}
